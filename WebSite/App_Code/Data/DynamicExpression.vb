...
Namespace TimberSmart.Data
    ...
    Public Class DynamicExpression
        ...
        Public Sub New(ByVal expression As XPathNavigator, ByVal nm As XmlNamespaceManager)
            MyBase.New
            Dim scope As XPathNavigator = expression.SelectSingleNode("parent::c:*", nm)
            Dim target As XPathNavigator = expression.SelectSingleNode("parent::c:*/parent::c:*", nm)
            ...
            Else
                ...
                End If
            End If
            Dim expressionType As String = expression.GetAttribute("type", String.Empty)
