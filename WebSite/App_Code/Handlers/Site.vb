...
Namespace TimberSmart.Handlers
    ...
    Public Class SiteBase
        Inherits TimberSmart.Web.PageBase
        ...
        Protected Overrides Sub OnInit(ByVal e As EventArgs)
            ...
            If m_IsTouchUI Then
                If (Not (m_PageFooterContent) Is Nothing) Then
                    m_PageFooterContent.Text = "<footer style=""display:none""><small>&copy; 2016 TimberSmart. ^Copyright^All right"& _ 
                        "s reserved.^Copyright^</small></footer>"
                End If
            Else
        ...
        Protected Overridable Sub InitializeSiteMaster()
            ...
            Dim themePath As String = Server.MapPath("~/App_Themes/TimberSmart")
            If Directory.Exists(themePath) Then
                For Each stylesheetFileName As String in Directory.GetFiles(themePath, "*.css")
                    ...
                    If Not (fileName.Equals("_Theme_Aquarium.css")) Then
                        ...
                        link.Href = ("~/App_Themes/TimberSmart/" + fileName)
