...
Namespace TimberSmart.Handlers
    ...
    Public Class Import
        ...
        Sub IHttpHandler_ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
            Dim parentId As String = context.Request.Params("parentId")
            Dim controller As String = context.Request.Params("controller")
            Dim view As String = context.Request.Params("view")
            ...
            Else
                If ((context.Request.HttpMethod = "POST") AndAlso (context.Request.Files.Count > 0)) Then
                    ...
                    Try 
                        ...
                        Dim fileName As String = context.Request.Files(0).FileName
                        ...
                        Dim ip As ImportProcessorBase = ImportProcessorFactory.Create(tempFileName)
                        Dim numberOfRecords As Integer = ip.CountRecords(tempFileName)
                        Dim availableImportFields As String = ip.CreateListOfAvailableFields(controller, view)
                        Dim fieldMap As String = ip.CreateInitialFieldMap(tempFileName, controller, view)
            ...
            Dim responseTemplate As String = "" & ControlChars.CrLf &"          " & ControlChars.CrLf &"<!DOCTYPE html PUBLIC ""-//W3C//DTD XHTML 1.0 Transitional//EN"" ""htt"& _ 
