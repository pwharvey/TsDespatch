...
Namespace TimberSmart.Web
    ...
    Public Class ControlHost
        ...
        Protected Overrides Sub OnInit(ByVal e As EventArgs)
            ...
            Dim controlName As String = Request.Params("control")
            ...
            If Not (String.IsNullOrEmpty(controlName)) Then
                ...
                If (Not (c) Is Nothing) Then
                    Dim editorAttributes() As Object = c.GetType().GetCustomAttributes(GetType(AquariumFieldEditorAttribute), true)
