...
Namespace TimberSmart.Web
    ...
    Public Class DataViewLookup
        ...
        Public Property SelectedValue() As String
            Get
                Dim v As String = CType(ViewState("SelectedValue"),String)
        ...
        Protected Property LookupText() As String
            Get
                Dim text As String = CType(ViewState("LookupText"),String)
        ...
        Public Property Enabled() As Boolean
            Get
                Dim v As Object = ViewState("Enabled")
                If (v Is Nothing) Then
                    Return true
                End If
        ...
        Public Property TabIndex() As Integer
            Get
                Dim v As Object = ViewState("TabIndex")
                If (v Is Nothing) Then
                    Return 0
                End If
        ...
        Protected Overrides Sub OnLoad(ByVal e As EventArgs)
            ...
            If Page.IsPostBack Then
                Dim valueKey As String = (m_Extender.ClientID + "_Item0")
