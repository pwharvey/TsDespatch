    ...
    Public Class AquariumExtenderBase
        ...
        Public Shared Sub RegisterFrameworkSettings(ByVal p As Page)
            If Not (p.ClientScript.IsStartupScriptRegistered(GetType(AquariumExtenderBase), "TargetFramework")) Then
                ...
                p.ClientScript.RegisterStartupScript(GetType(AquariumExtenderBase), "TouchUI", String.Format("var __settings={{appInfo:""TsDespatch|{0}"",mobileDisplayDensity:""Auto"",desktopDisp"& _ 
                            "layDensity:""Condensed"",mapApiIdentifier:"""",labelsInList:""DisplayedBelow"",labelsI"& _ 
                            "nForm:""AlignedLeft"",initialListMode:""SeeAll"",buttonShapes:true,sidebar:""Landscap"& _ 
                            "e"",promoteActions:true,transitions:"""",theme:""Aquarium"",maxPivotRowCount: {1},hel"& _ 
                            "p:true,ui:""TouchUI""{2}}};", BusinessRules.JavaScriptString(HttpContext.Current.User.Identity.Name), ApplicationServices.Create().MaxPivotRowCount, siteContent), true)
            End If
        End Sub
