...
Namespace TimberSmart.Web
    ...
    Public Class DataViewExtenderBase
        ...
        Private m_Transaction As DataTransactionMode
        ...
        Public Sub New()
            ...
            m_Transaction = DataTransactionMode.Supported
        End Sub
        ...
        Public Property ShowActionBar() As Boolean
            Get
                Return Me.m_ShowActionBar
            End Get
            Set
                Me.m_ShowActionBar = value
            End Set
        End Property
        ...
        Public Property VisibleWhen() As String
            Get
                Return Me.m_VisibleWhen
            End Get
            Set
                Me.m_VisibleWhen = value
            End Set
        End Property
        ...
        <System.ComponentModel.DefaultValue(DataTransactionMode.Supported)>  _
        Public Property Transaction() As DataTransactionMode
            Get
        ...
        Public Property ShowPageSize() As Boolean
            Get
                Return Me.m_ShowPageSize
            End Get
            Set
                Me.m_ShowPageSize = value
            End Set
        End Property
        ...
        Public Property ShowRowNumber() As Boolean
            Get
                Return Me.m_ShowRowNumber
            End Get
            Set
                Me.m_ShowRowNumber = value
            End Set
        End Property
        ...
        Public Property SearchByFirstLetter() As Boolean
            Get
                Return Me.m_SearchByFirstLetter
            End Get
            Set
                Me.m_SearchByFirstLetter = value
            End Set
        End Property
        ...
        Public Property AutoSelectFirstRow() As Boolean
            Get
                Return Me.m_AutoSelectFirstRow
            End Get
            Set
                Me.m_AutoSelectFirstRow = value
            End Set
        End Property
        ...
        Public Property AutoHighlightFirstRow() As Boolean
            Get
                Return Me.m_AutoHighlightFirstRow
            End Get
            Set
                Me.m_AutoHighlightFirstRow = value
            End Set
        End Property
        ...
        Public Property RefreshInterval() As Integer
            Get
                Return Me.m_RefreshInterval
            End Get
            Set
                Me.m_RefreshInterval = value
            End Set
        End Property
        ...
        Protected Overrides Sub ConfigureDescriptor(ByVal descriptor As ScriptBehaviorDescriptor)
            ...
            If m_LookupMode Then
                ...
                If AllowCreateLookupItems Then
                    descriptor.AddProperty("newViewId", TimberSmart.Data.Controller.LookupActionArgument(Controller, "New"))
                End If
            End If
            If Not (String.IsNullOrEmpty(FilterSource)) Then
                Dim source As Control = NamingContainer.FindControl(FilterSource)
            ...
            End If
            If Not ((Transaction = DataTransactionMode.NotSupported)) Then
                Dim t As String = Transaction.ToString()
                If (Not ((Transaction = DataTransactionMode.Supported)) OrElse ((Page.Request.Params("_transaction") = "true") AndAlso ((Page.Request.Params("_controller") = Me.Controller) AndAlso String.IsNullOrEmpty(Me.FilterSource)))) Then
                    t = Guid.NewGuid().ToString()
                End If
                descriptor.AddProperty("transaction", t)
            End If
            Dim visibleWhenExpression As String = VisibleWhen
        ...
        Private Function CreateFilterExpressions(ByVal filter() As FieldFilter) As SortedDictionary(Of String, String)
            ...
            Dim list As SortedDictionary(Of String, String) = New SortedDictionary(Of String, String)()
            For Each ff As FieldFilter in filter
                ...
                If TypeOf ff.Value Is Array Then
                    Dim values() As Object = CType(ff.Value,Object())
                    ...
                    Else
                        If ((ff.Operation = RowFilterOperation.Includes) OrElse (ff.Operation = RowFilterOperation.DoesNotInclude)) Then
                            Dim svb As StringBuilder = New StringBuilder()
        ...
        Public Overloads Sub AssignFilter(ByVal filter() As FieldFilter)
            Dim list As SortedDictionary(Of String, String) = CreateFilterExpressions(filter)
            'create a filter
            Dim sb As StringBuilder = New StringBuilder()
            sb.AppendFormat("var dv = Web.DataView.find('{0}');dv.beginFilter();var f;", Me.ID)
            For Each fieldName As String in list.Keys
        ...
        Public Overloads Sub AssignStartupFilter(ByVal filter() As FieldFilter)
            Dim list As SortedDictionary(Of String, String) = CreateFilterExpressions(filter)
            Dim dataViewFilter As List(Of String) = New List(Of String)()
            For Each fieldName As String in list.Keys
